...
Source signature: `aom_preprocess(X, y = None, *, operators = None, gating_mode: str | int = 'soft')` ([`n4m/_impl/native.py`](https://github.com/GBeurier/nirs4all-methods/blob/main/bindings/python/src/n4m/_impl/native.py#L5744)).
