...
**C ABI (ABI 2):** [`n4m_model_selection_aom_sweep_run`](https://github.com/GBeurier/nirs4all-methods/blob/main/cpp/include/n4m/model_selection.h#L324). Use the linked public header for the exact signature, configuration, and result handles.
