...
Source signature: [`piecewise_direct_standardization(X_source, X_target, X = None, window_size: int = 5, fit_intercept: bool = True, ridge: float = 0.0)`](https://github.com/GBeurier/nirs4all-methods/blob/main/bindings/python/src/n4m/_impl/native.py#L9800).
