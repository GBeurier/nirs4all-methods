...
**Signature:** [`signal_type_detector(X, wavelengths = None, confidence_threshold: float = 0.7)`](https://github.com/GBeurier/nirs4all-methods/blob/main/bindings/python/src/n4m/_impl/native.py#L10641)
