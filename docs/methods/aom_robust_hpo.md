...
**Signature:** [`aom_robust_hpo(X, y, *, profile: str | int = 'compact', cv: int = 5, heads = ('ridge', 'pls'))`](https://github.com/GBeurier/nirs4all-methods/blob/main/bindings/python/src/n4m/_impl/native.py#L9012)
