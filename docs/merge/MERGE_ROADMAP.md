...
| 12 | Unified repo | Tag `merge-complete/v1.0.0-rc1`. First stable release is `v1.0.0`. ABI ladder restarts (`N4M_ABI_VERSION_MAJOR=1`) because the symbol prefix changed. | CI green; benchmark dashboard rebuilt at `methods.nirs4all.org/`. |
