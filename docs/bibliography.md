...
**Current method references.** The reviewed citations and implementation provenance rendered on the method pages are in the generated [method-science reference index](methods/scientific-references.md). It checks every current DOI/URL locator and intentionally does not manufacture BibTeX from prose-only records.

This page is generated by `catalog/scripts/generate_bibliography.py`. The historical method citations below are a lossless, unreviewed archive: they preserve former source text and must not be treated as the current recommended reference without checking the method-science index. The separate finetuning records are structured only because their tracked BibTeX source and per-entry digests are reviewed by the scientific gate.
...
- [docs/_extras/methods_bibliography.py](https://github.com/GBeurier/nirs4all-methods/blob/4bd8f2f049e0e45d50c31541e5e4bef6107566fc/docs/_extras/methods_bibliography.py) — `140554600e9d2f835e1d11a383d9d389c730d86c5205a5f742ea8465824e6d30`
- [parity/REFERENCES.md](https://github.com/GBeurier/nirs4all-methods/blob/4bd8f2f049e0e45d50c31541e5e4bef6107566fc/parity/REFERENCES.md) — `52baac5aeedd0b3e6f58992e9d59ed2456442bfc249b7f9d5cd8e2235db20beb`
- [benchmarks/parity_timing/truth_sources.lock.json](https://github.com/GBeurier/nirs4all-methods/blob/4bd8f2f049e0e45d50c31541e5e4bef6107566fc/benchmarks/parity_timing/truth_sources.lock.json) — `a4955a2a577ac2a9c046fd874b3623540a6e925900084ec8fd82a52832836f1b`
- [docs/methods/_finetuning_bibliography.bib](https://github.com/GBeurier/nirs4all-methods/blob/4bd8f2f049e0e45d50c31541e5e4bef6107566fc/docs/methods/_finetuning_bibliography.bib) — `50c1ca245548898f3e740b8038a5336a5e5e431a5c2fc2e4093ea7bacb8a68d9` (reviewed structured source)
