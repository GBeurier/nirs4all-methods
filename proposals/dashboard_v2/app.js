...
if (!DATA) {
  document.getElementById('methods').innerHTML =
    '<div class="empty"><div class="big">⚠️</div><h3>bench-data.js failed to load</h3>' +
    '<p>window.BENCH_DATA is undefined. Ensure bench-data.js sits next to index.html.</p></div>';
