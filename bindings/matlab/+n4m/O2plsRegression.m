classdef O2plsRegression < n4m.MethodResultRegression
% n4m.O2plsRegression  O2-PLS (bi-directional OPLS).
    ...
    methods
        function obj = O2plsRegression(X, y, n_predictive, n_x_orthogonal, n_y_orthogonal)
            ...
            res = n4m.o2pls(X, y, n_predictive, n_x_orthogonal, n_y_orthogonal);
