...
% n4m.cars_select  Competitive Adaptive Reweighted Sampling.
%
%   res = n4m.cars_select(X, Y, K, n_iter, min_feats)
%
...
res = n4m.n4m_method_fit_mex("cars_select", double(X), double(Y), ...
