classdef RidgePlsRegression < n4m.MethodResultRegression
% n4m.RidgePlsRegression  L2-augmented PLS regression.
    ...
    methods
        function obj = RidgePlsRegression(X, y, n_components, ridge_lambda)
            ...
            res = n4m.ridge_pls(X, y, n_components, ridge_lambda);
