classdef RobustPlsRegression < n4m.MethodResultRegression
% n4m.RobustPlsRegression  Robust PLS via Huber IRLS.
    ...
    methods
        function obj = RobustPlsRegression(X, y, n_components, huber_k, max_irls_iter)
            ...
            res = n4m.robust_pls(X, y, n_components, huber_k, max_irls_iter);
