...
% n4m.pls_diagnostics  Hotelling T2, Q residuals, DModX from a SIMPLS fit.
%
%   res = n4m.pls_diagnostics(X, Y, n_components)
%   res = n4m.pls_diagnostics(X, Y, n_components, X_reference)
%
...
res = n4m.n4m_method_fit_mex("pls_diagnostics_compute", ...
                                  double(X), double(Y), ...
