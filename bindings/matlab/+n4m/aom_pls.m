function res = aom_pls(X, Y, max_components, n_operators, cv)
% n4m.aom_pls  AOM-PLS global operator selection.
...
params = struct("max_components", int32(max_components), ...
                ...
                "cv", int32(cv));
res = n4m.n4m_method_fit_mex("aom_pls", double(X), double(Y), ...
