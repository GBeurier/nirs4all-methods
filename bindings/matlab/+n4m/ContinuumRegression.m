classdef ContinuumRegression < n4m.MethodResultRegression
% n4m.ContinuumRegression  Continuum regression (tau ∈ [0, 1]).
    ...
    methods
        function obj = ContinuumRegression(X, y, n_components, tau)
            ...
            res = n4m.continuum_regression(X, y, n_components, tau);
