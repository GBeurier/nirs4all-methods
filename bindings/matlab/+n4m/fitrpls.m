...
%
%   MDL = n4m.fitrpls(X, y) — fits a 2-component PLS regression.
%   MDL = n4m.fitrpls(X, y, "NumComponents", K) — K components.
%
% Returns an instance of n4m.Regression. Mirrors the calling
...
%
% See also: n4m.Regression, predict, loss, score.
    ...
    mdl = n4m.Regression(X, y, p.Results.NumComponents);
end
