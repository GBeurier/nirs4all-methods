...
% n4m.selectivity_ratio_select  Selectivity-ratio feature ranking.
%
%   res = n4m.selectivity_ratio_select(X, Y, n_components, top_k)
%
...
params = struct("method", int32(2), ...
                "top_k", int32(top_k));
res = n4m.n4m_method_fit_mex("variable_select_rank", ...
                                  double(X), double(Y), ...
