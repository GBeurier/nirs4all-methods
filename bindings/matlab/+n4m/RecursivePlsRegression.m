classdef RecursivePlsRegression < n4m.MethodResultRegression
% n4m.RecursivePlsRegression  Moving-window recursive PLS.
...
% (length-preserved; warmup samples are 0).
    ...
    methods
        function obj = RecursivePlsRegression(X, y, n_components, window_size)
            ...
            res = n4m.recursive_pls(X, y, n_components, window_size);
