classdef KernelPlsRegression < n4m.MethodResultRegression
% n4m.KernelPlsRegression  Non-linear kernel PLS (Rosipal & Trejo 2001).
%
...
% training matrix (content equality), otherwise raises an error.
    ...
    methods
        function obj = KernelPlsRegression(X, y, n_components, kernel_type, gamma, coef0, degree)
            ...
            res = n4m.kernel_pls(X, y, n_components, kernel_type, gamma, coef0, degree);
