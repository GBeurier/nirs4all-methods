function res = pls_monitoring(X_reference, Y_reference, X_monitor, ...
                                n_components, alpha)
% n4m.pls_monitoring  PLS process monitoring (Hotelling T^2 + Q).
%
%   res = n4m.pls_monitoring(X_ref, Y_ref, X_mon, n_components)
%   res = n4m.pls_monitoring(X_ref, Y_ref, X_mon, n_components, alpha)
%
...
params = struct("X_monitor", double(X_monitor), ...
                "alpha", double(alpha));
res = n4m.n4m_method_fit_mex("pls_monitoring_run", ...
                                  double(X_reference), ...
                                  double(Y_reference), ...
