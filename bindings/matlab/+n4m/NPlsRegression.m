classdef NPlsRegression < n4m.MethodResultRegression
% n4m.NPlsRegression  N-PLS (3-way tensor) regression (Bro 1996).
    ...
    methods
        function obj = NPlsRegression(X_flat, y, n_components, mode_j, mode_k)
            ...
            res = n4m.n_pls(X_flat, y, n_components, mode_j, mode_k);
