...
% pls4all.kennard_stone_split  Kennard-Stone train/test split.
%
%   SPLIT = pls4all.kennard_stone_split(X)
%   SPLIT = pls4all.kennard_stone_split(X, 'test_size', 0.25, 'zero_based', false)

opts = parse_options(varargin{:});
split = pls4all.n4m_split_mex( ...
