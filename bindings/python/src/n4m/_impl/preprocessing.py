...
class LSNV(StatelessOperator):
    ...
    def _create_handle(self):
        ...
        check(
            lib.n4m_transform_local_snv_create(
                ctypes.byref(h),
...
class RNV(StatelessOperator):
    ...
    def _create_handle(self):
        h = ctypes.c_void_p()
        check(
            lib.n4m_transform_robust_snv_create(
                ctypes.byref(h),
...
class AreaNormalization(StatelessOperator):
    ...
    _C_PREFIX = "n4m_transform_area_normalization"
...
class Normalize(StatelessOperator):
    ...
    _C_PREFIX = "n4m_transform_normalize"
    ...
    def _create_handle(self):
        h = ctypes.c_void_p()
        check(
            lib.n4m_transform_normalize_create(
                ctypes.byref(h),
                ctypes.c_double(self.feature_min),
                ctypes.c_double(self.feature_max),
            ),
            "n4m_transform_normalize_create",
        )
        return h
...
class SimpleScale(StatelessOperator):
    ...
    _C_PREFIX = "n4m_transform_simple_scale"
    ...
    def _create_handle(self):
        h = ctypes.c_void_p()
        check(
            lib.n4m_transform_simple_scale_create(ctypes.byref(h)),
            "n4m_transform_simple_scale_create",
        )
        return h
...
class LogTransform(StatefulOperator):
    ...
    _C_PREFIX = "n4m_transform_log_transform"
    ...
    def _create_handle(self):
        h = ctypes.c_void_p()
        check(
            lib.n4m_transform_log_transform_create(
                ctypes.byref(h),
...
class EMSC(StatefulOperator):
    ...
    def _create_handle(self):
        h = ctypes.c_void_p()
        check(
            lib.n4m_transform_emsc_create(ctypes.byref(h), ctypes.c_int32(self.degree)),
            "n4m_transform_emsc_create",
        )
        return h
...
class BaselineCenter(StatefulOperator):
    ...
    _C_PREFIX = "n4m_transform_baseline_center"
...
class Derivate(StatefulOperator):
    ...
    _C_PREFIX = "n4m_transform_derivative"
    ...
    def _create_handle(self):
        h = ctypes.c_void_p()
        check(
            lib.n4m_transform_derivative_create(
                ctypes.byref(h),
                ctypes.c_int32(self.order),
                ctypes.c_double(self.delta),
            ),
            "n4m_transform_derivative_create",
        )
        return h
...
class SavitzkyGolay(StatelessOperator):
    ...
    def _create_handle(self):
        ...
        check(
            lib.n4m_transform_savitzky_golay_create(
                ctypes.byref(h),
...
class NorrisWilliams(StatelessOperator):
    ...
    _C_PREFIX = "n4m_transform_norris_williams"
    ...
    def _create_handle(self):
        h = ctypes.c_void_p()
        check(
            lib.n4m_transform_norris_williams_create(
                ctypes.byref(h),
...
class Gaussian(StatelessOperator):
    ...
    _C_PREFIX = "n4m_transform_gaussian"
    ...
    def _create_handle(self):
        ...
        check(
            lib.n4m_transform_gaussian_create(
                ctypes.byref(h),
...
class FirstDerivative(StatelessOperator):
    ...
    _C_PREFIX = "n4m_transform_first_derivative"
    ...
    def _create_handle(self):
        h = ctypes.c_void_p()
        check(
            lib.n4m_transform_first_derivative_create(
                ctypes.byref(h),
                ctypes.c_double(self.delta),
...
class SecondDerivative(StatelessOperator):
    ...
    _C_PREFIX = "n4m_transform_second_derivative"
    ...
    def _create_handle(self):
        h = ctypes.c_void_p()
        check(
            lib.n4m_transform_second_derivative_create(
                ctypes.byref(h),
                ctypes.c_double(self.delta),
                ctypes.c_int32(self.edge_order),
            ),
...
class ToAbsorbance(StatelessOperator):
    ...
    def _create_handle(self):
        h = ctypes.c_void_p()
        check(
            lib.n4m_transform_to_absorbance_create(
                ctypes.byref(h),
...
class FromAbsorbance(StatelessOperator):
    ...
    _C_PREFIX = "n4m_transform_from_absorbance"
    ...
    def _create_handle(self):
        h = ctypes.c_void_p()
        check(
            lib.n4m_transform_from_absorbance_create(
                ctypes.byref(h), ctypes.c_int(1 if self.is_percent else 0)
            ),
            "n4m_transform_from_absorbance_create",
        )
        return h
...
class PercentToFraction(StatelessOperator):
    ...
    _C_PREFIX = "n4m_transform_percent_to_fraction"
    ...
    def _create_handle(self):
        h = ctypes.c_void_p()
        check(
            lib.n4m_transform_percent_to_fraction_create(ctypes.byref(h)),
            "n4m_transform_percent_to_fraction_create",
        )
        return h
...
class FractionToPercent(StatelessOperator):
    ...
    _C_PREFIX = "n4m_transform_fraction_to_percent"
    ...
    def _create_handle(self):
        h = ctypes.c_void_p()
        check(
            lib.n4m_transform_fraction_to_percent_create(ctypes.byref(h)),
            "n4m_transform_fraction_to_percent_create",
        )
        return h
...
class KubelkaMunk(StatelessOperator):
    ...
    _C_PREFIX = "n4m_transform_kubelka_munk"
    ...
    def _create_handle(self):
        h = ctypes.c_void_p()
        check(
            lib.n4m_transform_kubelka_munk_create(
                ctypes.byref(h),
                ctypes.c_int(1 if self.is_percent else 0),
                ctypes.c_double(self.epsilon),
            ),
            "n4m_transform_kubelka_munk_create",
        )
        return h
