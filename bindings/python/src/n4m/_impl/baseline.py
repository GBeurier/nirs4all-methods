...
from .estimator_base import StatelessOperator


class Detrend(StatelessOperator):
    """Polynomial baseline subtraction."""

    _C_PREFIX = "n4m_transform_detrend"
    ...
    def _create_handle(self):
        h = ctypes.c_void_p()
        check(
            lib.n4m_transform_detrend_create(ctypes.byref(h), ctypes.c_int32(self.polyorder)),
            "n4m_transform_detrend_create",
        )
        return h
...
class AirPLS(StatelessOperator):
    ...
    _C_PREFIX = "n4m_transform_airpls"
    ...
    def _create_handle(self):
        h = ctypes.c_void_p()
        check(
            lib.n4m_transform_airpls_create(
                ctypes.byref(h),
                ctypes.c_double(self.lam),
                ctypes.c_int32(self.max_iter),
                ctypes.c_double(self.tol),
...
class ArPLS(StatelessOperator):
    ...
    def _create_handle(self):
        h = ctypes.c_void_p()
        check(
            lib.n4m_transform_arpls_create(
                ctypes.byref(h),
                ctypes.c_double(self.lam),
                ctypes.c_int32(self.max_iter),
                ctypes.c_double(self.tol),
...
class ModPoly(StatelessOperator):
    ...
    _C_PREFIX = "n4m_transform_modpoly"
    ...
    def _create_handle(self):
        h = ctypes.c_void_p()
        check(
            lib.n4m_transform_modpoly_create(
                ctypes.byref(h),
...
class IModPoly(StatelessOperator):
    ...
    _C_PREFIX = "n4m_transform_imodpoly"
    ...
    def _create_handle(self):
        h = ctypes.c_void_p()
        check(
            lib.n4m_transform_imodpoly_create(
                ctypes.byref(h),
                ctypes.c_int32(self.polyorder),
                ctypes.c_int32(self.max_iter),
                ctypes.c_double(self.tol),
...
class SNIP(StatelessOperator):
    ...
    def _create_handle(self):
        h = ctypes.c_void_p()
        check(
            lib.n4m_transform_snip_create(
                ctypes.byref(h), ctypes.c_int32(self.max_half_window)
            ),
            "n4m_transform_snip_create",
        )
        return h
...
class RollingBall(StatelessOperator):
    ...
    _C_PREFIX = "n4m_transform_rolling_ball"
    ...
    def _create_handle(self):
        h = ctypes.c_void_p()
        check(
            lib.n4m_transform_rolling_ball_create(
                ctypes.byref(h),
                ctypes.c_int32(self.half_window),
                ctypes.c_int32(self.smooth_half_window),
            ),
            "n4m_transform_rolling_ball_create",
        )
        return h
...
class IAsLS(StatelessOperator):
    ...
    def _create_handle(self):
        h = ctypes.c_void_p()
        check(
            lib.n4m_transform_iasls_create_ex(
                ctypes.byref(h),
                ctypes.c_double(self.lam),
                ctypes.c_double(self.p),
...
class BEADS(StatelessOperator):
    ...
    def _create_handle(self):
        h = ctypes.c_void_p()
        check(
            lib.n4m_transform_beads_create(
                ctypes.byref(h),
