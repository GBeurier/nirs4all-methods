...
from .estimator_base import StatefulOperator, StatelessOperator
from .compat import BaseEstimator, TransformerMixin
...
class Wavelet(StatelessOperator):
    ...
    _C_PREFIX = "n4m_transform_wavelet"
...
class Haar(StatelessOperator):
    ...
    def _create_handle(self):
        h = ctypes.c_void_p()
        check(lib.n4m_transform_haar_create(ctypes.byref(h)), "n4m_transform_haar_create")
        return h
...
class WaveletDenoise(BaseEstimator, TransformerMixin):
    ...
    _C_PREFIX = "n4m_transform_wavelet_denoise"
    ...
    def _create_handle(self):
        h = ctypes.c_void_p()
        check(
            lib.n4m_transform_wavelet_denoise_create(
                ctypes.byref(h),
    ...
    def transform(self, X) -> np.ndarray:
        ...
        check(
            lib.n4m_transform_wavelet_denoise_transform(
    ...
    def __del__(self):
        if self._handle is not None and self._handle.value:
            lib.n4m_transform_wavelet_denoise_destroy(self._handle)
            self._handle = None
...
class WaveletFeatures(StatelessOperator):
    ...
    _C_PREFIX = "n4m_transform_wavelet_features"
    ...
    def _create_handle(self):
        h = ctypes.c_void_p()
        check(
            lib.n4m_transform_wavelet_features_create_ex(
                ctypes.byref(h),
                ctypes.c_int(self._family),
                ctypes.c_int(self._mode),
...
class WaveletPCA(_WaveletProjection):
    ...
    _C_PREFIX = "n4m_transform_wavelet_pca"
...
class WaveletSVD(_WaveletProjection):
    ...
    _C_PREFIX = "n4m_transform_wavelet_svd"
...
class GaussianAdditiveNoise(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_gaussian_noise"
...
class MultiplicativeNoise(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_multiplicative_noise"
...
class SpikeNoise(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_spike_noise"
...
class HeteroscedasticNoiseAugmenter(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_hetero_noise"
...
class LinearBaselineDrift(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_linear_drift"
...
class PolynomialBaselineDrift(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_poly_drift"
...
class PathLengthAugmenter(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_path_length"
...
class WavelengthShift(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_wavelength_shift"
...
class WavelengthStretch(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_wavelength_stretch"
...
class LocalWarpAugmenter(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_local_warp"
...
class BandPerturbationAugmenter(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_band_perturb"
...
class BandMasking(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_band_mask"
...
class ChannelDropout(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_channel_dropout"
...
class GaussianJitter(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_gauss_jitter"
...
class UnsharpMask(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_unsharp_mask"
...
class MagnitudeWarp(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_magnitude_warp"
...
class LocalClip(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_local_clip"
...
class MixupAugmenter(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_mixup"
...
class LocalMixupAugmenter(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_local_mixup"
...
class ScatterSimulationMSC(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_scatter_sim_msc"
...
class ParticleSizeAugmenter(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_particle_size"
...
class EMSCDistortionAugmenter(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_emsc_distort"
...
class BatchEffectAugmenter(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_batch_effect"
...
class InstrumentalBroadeningAugmenter(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_instrument_broaden"
...
class DeadBandAugmenter(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_dead_band"
...
class TemperatureAugmenter(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_temperature"
...
class MoistureAugmenter(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_moisture"
...
class DetectorRollOffAugmenter(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_detector_rolloff"
...
class EdgeCurvatureAugmenter(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_edge_curvature"
    _APPLY_WAVELENGTHS = True
...
class TruncatedPeakAugmenter(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_truncated_peak"
    _APPLY_WAVELENGTHS = True
...
class EdgeArtifactsAugmenter(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_edge_artifacts"
    _APPLY_WAVELENGTHS = True
...
class SplineSmoothingAugmenter(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_spline_smoothing"
...
class SplineXPerturbationAugmenter(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_spline_x_perturbations"
...
class SplineYPerturbationAugmenter(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_spline_y_perturbations"
...
class SplineXSimplificationAugmenter(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_spline_x_simplification"
...
class SplineCurveSimplificationAugmenter(SplineXSimplificationAugmenter):
    ...
    _C_PREFIX = "n4m_augmentation_spline_curve_simplification"


class RotateTranslateAugmenter(_AugmenterBase):
    """Random rotate/translate spectral augmentation."""

    _C_PREFIX = "n4m_augmentation_rotate_translate"
...
class RandomXOperation(_AugmenterBase):
    ...
    _C_PREFIX = "n4m_augmentation_random_x_op"
