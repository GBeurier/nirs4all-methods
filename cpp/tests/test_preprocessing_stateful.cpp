...
// dedicated `n4m_transform_derivative_output_cols(2, 200) == 198` shape-helper
...
void test_msc_smoke() {
    ...
    N4M_TEST_REQUIRE(n4m_transform_msc_create(&h) == N4M_OK);
    N4M_TEST_REQUIRE(h != nullptr);

    int fitted = 1;
    N4M_TEST_REQUIRE(n4m_transform_msc_is_fitted(h, &fitted) == N4M_OK);
    N4M_TEST_REQUIRE(fitted == 0);

    n4m_matrix_view_t Xfv = make_rowmajor_view(Xfit, 3, 4);
    N4M_TEST_REQUIRE(n4m_transform_msc_fit(h, Xfv) == N4M_OK);
    ...
    N4M_TEST_REQUIRE(n4m_transform_msc_transform(h, Xv, Yv) == N4M_OK);
    ...
    n4m_transform_msc_destroy(nullptr);  // null-safe
}

void test_msc_reference_roundtrip() {
    double train[12] = {1.0, 2.0, 3.0, 4.0,
                        2.5, 4.0, 6.5, 8.0,
                        0.8, 1.4, 2.2, 3.1};
    double test[8] = {1.2, 2.2, 3.3, 4.7,
                      1.9, 3.8, 5.5, 7.5};
    double original[8] = {0}, restored[8] = {0};
    double reference[4] = {0};
    n4m_pp_msc_handle_t *fitted = nullptr, *imported = nullptr;
    N4M_TEST_REQUIRE(n4m_transform_msc_create(&fitted) == N4M_OK);
    N4M_TEST_REQUIRE(n4m_transform_msc_create(&imported) == N4M_OK);
    int64_t cols = -1;
    N4M_TEST_REQUIRE(n4m_transform_msc_reference_size(fitted, &cols) == N4M_ERR_NOT_FITTED);
    N4M_TEST_REQUIRE(n4m_transform_msc_get_reference(fitted, reference, 4) == N4M_ERR_NOT_FITTED);
    N4M_TEST_REQUIRE(n4m_transform_msc_fit(fitted, make_rowmajor_view(train, 3, 4)) == N4M_OK);
    N4M_TEST_REQUIRE(n4m_transform_msc_reference_size(fitted, &cols) == N4M_OK);
    N4M_TEST_REQUIRE(cols == 4);
    N4M_TEST_REQUIRE(n4m_transform_msc_get_reference(fitted, reference, 3) == N4M_ERR_SHAPE_MISMATCH);
    N4M_TEST_REQUIRE(n4m_transform_msc_get_reference(fitted, reference, 4) == N4M_OK);
    N4M_TEST_REQUIRE(n4m_transform_msc_set_reference(imported, reference, 4) == N4M_OK);
    N4M_TEST_REQUIRE(n4m_transform_msc_transform(fitted, make_rowmajor_view(test, 2, 4),
                                                   make_rowmajor_view(original, 2, 4)) == N4M_OK);
    ...
    N4M_TEST_REQUIRE(cols == 4);
    n4m_transform_msc_destroy(fitted);
    n4m_transform_msc_destroy(imported);
}
...
void test_emsc_smoke() {
    ...
    N4M_TEST_REQUIRE(n4m_transform_emsc_create(&h, /*degree=*/2) == N4M_OK);
    N4M_TEST_REQUIRE(h != nullptr);

    n4m_matrix_view_t Xv = make_rowmajor_view(X, 3, 4);
    N4M_TEST_REQUIRE(n4m_transform_emsc_fit(h, Xv) == N4M_OK);
    n4m_matrix_view_t Yv = make_rowmajor_view(Y, 3, 4);
    N4M_TEST_REQUIRE(n4m_transform_emsc_transform(h, Xv, Yv) == N4M_OK);
    for (int k = 0; k < 12; ++k) {
        N4M_TEST_REQUIRE(std::isfinite(Y[k]));
    }
...
void test_baseline_smoke() {
    ...
    N4M_TEST_REQUIRE(n4m_transform_baseline_center_create(&h) == N4M_OK);

    n4m_matrix_view_t Xv = make_rowmajor_view(X, 2, 3);
    N4M_TEST_REQUIRE(n4m_transform_baseline_center_fit(h, Xv) == N4M_OK);
    n4m_matrix_view_t Yv = make_rowmajor_view(Y, 2, 3);
    N4M_TEST_REQUIRE(n4m_transform_baseline_center_transform(h, Xv, Yv) == N4M_OK);
    ...
    n4m_transform_baseline_center_destroy(h);
}
...
void test_baseline_inverse() {
    ...
    N4M_TEST_REQUIRE(n4m_transform_baseline_center_fit(h, Xv) == N4M_OK);
    N4M_TEST_REQUIRE(n4m_transform_baseline_center_transform(h, Xv, Yv) == N4M_OK);
    N4M_TEST_REQUIRE(n4m_transform_baseline_center_inverse_transform(h, Yv, Zv) == N4M_OK);
    for (int k = 0; k < 6; ++k) {
...
void test_derivate_smoke() {
    ...
    N4M_TEST_REQUIRE(n4m_transform_derivative_create(&h, /*order=*/1,
                                              /*delta=*/1.0) == N4M_OK);
    n4m_matrix_view_t Xv = make_rowmajor_view(X, 2, 4);
    n4m_matrix_view_t Yv = make_rowmajor_view(Y, 2, 3);
    N4M_TEST_REQUIRE(n4m_transform_derivative_fit(h, Xv) == N4M_OK);
    N4M_TEST_REQUIRE(n4m_transform_derivative_transform(h, Xv, Yv) == N4M_OK);
    ...
    n4m_transform_derivative_destroy(h);
}

void test_derivate_output_cols() {
    N4M_TEST_REQUIRE(n4m_transform_derivative_output_cols(2, 200) == 198);
    N4M_TEST_REQUIRE(n4m_transform_derivative_output_cols(1, 10)  == 9);
    N4M_TEST_REQUIRE(n4m_transform_derivative_output_cols(3, 200) == 197);
    // Degenerate: order >= input_cols → 0 (out-of-range).
    N4M_TEST_REQUIRE(n4m_transform_derivative_output_cols(10, 10) == 0);
    N4M_TEST_REQUIRE(n4m_transform_derivative_output_cols(1, 1)   == 0);
}
...
void test_msc_not_fitted() {
    ...
    n4m_matrix_view_t Xv = make_rowmajor_view(X, 2, 3);
    n4m_matrix_view_t Yv = make_rowmajor_view(Y, 2, 3);
    N4M_TEST_REQUIRE(n4m_transform_msc_transform(h, Xv, Yv) == N4M_ERR_NOT_FITTED);
    N4M_TEST_REQUIRE(n4m_transform_msc_inverse_transform(h, Xv, Yv) == N4M_ERR_NOT_FITTED);
    n4m_transform_msc_destroy(h);
}
...
void test_emsc_not_fitted() {
    ...
    n4m_matrix_view_t Xv = make_rowmajor_view(X, 2, 3);
    n4m_matrix_view_t Yv = make_rowmajor_view(Y, 2, 3);
    N4M_TEST_REQUIRE(n4m_transform_emsc_transform(h, Xv, Yv) == N4M_ERR_NOT_FITTED);
    n4m_transform_emsc_destroy(h);
}
...
void test_baseline_not_fitted() {
    ...
    n4m_matrix_view_t Xv = make_rowmajor_view(X, 2, 3);
    n4m_matrix_view_t Yv = make_rowmajor_view(Y, 2, 3);
    N4M_TEST_REQUIRE(n4m_transform_baseline_center_transform(h, Xv, Yv) == N4M_ERR_NOT_FITTED);
    N4M_TEST_REQUIRE(n4m_transform_baseline_center_inverse_transform(h, Xv, Yv) == N4M_ERR_NOT_FITTED);
    n4m_transform_baseline_center_destroy(h);
}
...
void test_derivate_not_fitted() {
    ...
    double Y[6] = {0};
    n4m_pp_derivate_handle_t* h = nullptr;
    N4M_TEST_REQUIRE(n4m_transform_derivative_create(&h, 1, 1.0) == N4M_OK);
    n4m_matrix_view_t Xv = make_rowmajor_view(X, 2, 4);
    n4m_matrix_view_t Yv = make_rowmajor_view(Y, 2, 3);
    N4M_TEST_REQUIRE(n4m_transform_derivative_transform(h, Xv, Yv) == N4M_ERR_NOT_FITTED);
    n4m_transform_derivative_destroy(h);
}
    ...
    for (const auto& c : fx.cases) {
        ...
        if (variant == "inverse") {
            ...
            n4m_matrix_view_t Ov = make_rowmajor_view(out.data(),
                                                       fx.rows, fx.cols);
            N4M_TEST_REQUIRE(n4m_transform_msc_transform(h, Xv, Mv) == N4M_OK);
            N4M_TEST_REQUIRE(n4m_transform_msc_inverse_transform(h, Mv, Ov) == N4M_OK);
...
void verify_emsc_parity() {
    ...
    for (const auto& c : fx.cases) {
        const int degree = static_cast<int>(params_get_int(c.params_json,
                                                            "degree", 2));
        n4m_pp_emsc_handle_t* h = nullptr;
        N4M_TEST_REQUIRE(n4m_transform_emsc_create(&h, degree) == N4M_OK);
        std::vector<double> fit_in = fx.fit_input;
        n4m_matrix_view_t Xfv = make_rowmajor_view(fit_in.data(),
                                                    fx.fit_rows, fx.fit_cols);
        N4M_TEST_REQUIRE(n4m_transform_emsc_fit(h, Xfv) == N4M_OK);
...
void verify_baseline_parity() {
    ...
    for (const auto& c : fx.cases) {
        ...
        n4m_matrix_view_t Xfv = make_rowmajor_view(fit_in.data(),
                                                    fx.fit_rows, fx.fit_cols);
        N4M_TEST_REQUIRE(n4m_transform_baseline_center_fit(h, Xfv) == N4M_OK);
        ...
        if (variant == "test") {
            ...
            n4m_matrix_view_t Ov = make_rowmajor_view(out.data(),
                                                       fx.fit_rows, fx.fit_cols);
            N4M_TEST_REQUIRE(n4m_transform_baseline_center_transform(h, Xv, Mv) == N4M_OK);
            N4M_TEST_REQUIRE(n4m_transform_baseline_center_inverse_transform(h, Mv, Ov) == N4M_OK);
            assert_close(out, c.expected_output, "baseline/" + c.name,
                         1e-12, 1e-13);
        } else {
...
void verify_derivate_parity() {
    ...
    for (const auto& c : fx.cases) {
        ...
        n4m_pp_derivate_handle_t* h = nullptr;
        N4M_TEST_REQUIRE(n4m_transform_derivative_create(&h, order, delta) == N4M_OK);
        std::vector<double> fit_in = fx.fit_input;
        n4m_matrix_view_t Xfv = make_rowmajor_view(fit_in.data(),
                                                    fx.fit_rows, fx.fit_cols);
        N4M_TEST_REQUIRE(n4m_transform_derivative_fit(h, Xfv) == N4M_OK);
...
void test_msc_refit_replaces_state() {
    ...
    N4M_TEST_REQUIRE(n4m_transform_msc_fit(h, vX1) == N4M_OK);
    N4M_TEST_REQUIRE(n4m_transform_msc_transform(h, vX3, voutA) == N4M_OK);
    N4M_TEST_REQUIRE(n4m_transform_msc_fit(h, vX2) == N4M_OK);
    N4M_TEST_REQUIRE(n4m_transform_msc_transform(h, vX3, voutB) == N4M_OK);
...
void test_emsc_refit_replaces_state() {
    ...
    N4M_TEST_REQUIRE(n4m_transform_emsc_fit(h, vX1) == N4M_OK);
    N4M_TEST_REQUIRE(n4m_transform_emsc_transform(h, vX3, voutA) == N4M_OK);
    N4M_TEST_REQUIRE(n4m_transform_emsc_fit(h, vX2) == N4M_OK);
    N4M_TEST_REQUIRE(n4m_transform_emsc_transform(h, vX3, voutB) == N4M_OK);
    bool any_diff = false;
    for (int i = 0; i < 8; ++i) {
        if (std::fabs(outA[i] - outB[i]) > 1e-9) { any_diff = true; break; }
    }
...
void test_baseline_refit_replaces_state() {
    ...
    n4m_matrix_view_init_rowmajor(&voutA, outA, 2, 3, N4M_DTYPE_F64);
    n4m_matrix_view_init_rowmajor(&voutB, outB, 2, 3, N4M_DTYPE_F64);
    N4M_TEST_REQUIRE(n4m_transform_baseline_center_fit(h, vX1) == N4M_OK);
    N4M_TEST_REQUIRE(n4m_transform_baseline_center_transform(h, vX3, voutA) == N4M_OK);
    /* mean(X1) is all zeros, so outA == X3 */
    for (int i = 0; i < 6; ++i) N4M_TEST_REQUIRE(std::fabs(outA[i] - X3[i]) < 1e-15);
    N4M_TEST_REQUIRE(n4m_transform_baseline_center_fit(h, vX2) == N4M_OK);
    N4M_TEST_REQUIRE(n4m_transform_baseline_center_transform(h, vX3, voutB) == N4M_OK);
...
void register_preprocessing_stateful_tests(n4m_testing::Runner& r) {
    ...
    r.run("pp_msc_reference_roundtrip", test_msc_reference_roundtrip);
