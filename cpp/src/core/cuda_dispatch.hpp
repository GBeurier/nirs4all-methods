...
// N4M_USE_CUDA is defined — the header itself is safe to include
...
// first call; safe to invoke from n4m_backend_is_available without
...
// cuBLAS errors. Callers in libn4m's hot path do not propagate
...
// truncate. Every internal libn4m call site honours this; Phase 45b
