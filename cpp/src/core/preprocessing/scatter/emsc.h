 ...
 * (EMSC) preprocessing operator. The public C ABI lives in n4m.h and is
 ...
 */
#ifndef N4M_CORE_PP_SCATTER_EMSC_H
#define N4M_CORE_PP_SCATTER_EMSC_H
...
#endif /* N4M_CORE_PP_SCATTER_EMSC_H */
