...
//
//   n4m_aug_<NAME>_create(handle_t** out,
//                         n4m_rng_pcg64_state_t* rng,
//                         /* operator-specific params */);
//   n4m_aug_<NAME>_apply(const handle_t* handle,
//                        n4m_matrix_view_t X, n4m_matrix_view_t out);
//   n4m_aug_<NAME>_destroy(handle_t* handle);
//
...
template <typename T>
n4m_status_t validate_view(n4m_matrix_view_t v, int64_t& rows, int64_t& cols,
                            T*& data) {
...
n4m_status_t validate_shapes(n4m_matrix_view_t X, n4m_matrix_view_t Y) {
...
// MixupAugmenter
// ============================================================================
struct n4m_aug_mixup_handle_t {
    n4m_aug_mixup_state_t* state;
    n4m_rng_pcg64_state_t* rng;
};
...
N4M_API n4m_status_t n4m_augmentation_mixup_create(n4m_aug_mixup_handle_t** out,
    ...
    *out = nullptr;
    ...
    try {
        n4m_aug_mixup_state_t* s = n4m_aug_mixup_state_new(alpha);
        if (s == nullptr) return N4M_ERR_INVALID_ARGUMENT;
        auto* h = new n4m_aug_mixup_handle_t{s, rng};
        *out = h;
        return N4M_OK;
...
N4M_API n4m_status_t n4m_augmentation_mixup_apply(const n4m_aug_mixup_handle_t* h,
    ...
    double* Yp = nullptr;
    n4m_status_t st = validate_view<const double>(X, rows, cols, Xp);
...
// LocalMixupAugmenter
// ============================================================================
struct n4m_aug_local_mixup_handle_t {
    n4m_aug_local_mixup_state_t* state;
    n4m_rng_pcg64_state_t* rng;
};
...
N4M_API n4m_status_t n4m_augmentation_local_mixup_create(n4m_aug_local_mixup_handle_t** out,
    ...
    *out = nullptr;
    if (rng == nullptr) return N4M_ERR_NULL_POINTER;
    try {
        auto* s = n4m_aug_local_mixup_state_new(alpha, k_neighbors);
        if (s == nullptr) return N4M_ERR_INVALID_ARGUMENT;
        auto* h = new n4m_aug_local_mixup_handle_t{s, rng};
        *out = h;
        return N4M_OK;
...
// ============================================================================
struct n4m_aug_scatter_sim_handle_t {
    n4m_aug_scatter_sim_state_t* state;
    n4m_rng_pcg64_state_t* rng;
};
...
N4M_API n4m_status_t n4m_augmentation_scatter_sim_msc_create(n4m_aug_scatter_sim_handle_t** out,
    ...
    *out = nullptr;
    if (rng == nullptr) return N4M_ERR_NULL_POINTER;
    try {
        auto* s = n4m_aug_scatter_sim_state_new(a_low, a_high, b_low, b_high);
        if (s == nullptr) return N4M_ERR_INVALID_ARGUMENT;
        auto* h = new n4m_aug_scatter_sim_handle_t{s, rng};
        *out = h;
        return N4M_OK;
    } catch (const std::bad_alloc&) { return N4M_ERR_OUT_OF_MEMORY; }
      catch (...) { return N4M_ERR_INTERNAL; }
...
N4M_API n4m_status_t n4m_augmentation_scatter_sim_msc_apply(const n4m_aug_scatter_sim_handle_t* h,
    ...
    if ((st = validate_shapes(X, out)) != N4M_OK) return st;
    try {
        return n4m_aug_scatter_sim_apply_impl(h->state, &h->rng->engine,
                                               Xp, rows, cols, Yp);
    } catch (...) { return N4M_ERR_INTERNAL; }
}
...
// ============================================================================
struct n4m_aug_particle_size_handle_t {
    n4m_aug_particle_size_state_t* state;
    n4m_rng_pcg64_state_t* rng;
    double* wavelengths;
...
N4M_API n4m_status_t n4m_augmentation_particle_size_create(
    ...
    if (out == nullptr) return N4M_ERR_NULL_POINTER;
    *out = nullptr;
    if (rng == nullptr || wavelengths == nullptr) return N4M_ERR_NULL_POINTER;
    if (n_wavelengths <= 0) return N4M_ERR_INVALID_ARGUMENT;
    try {
        auto* s = n4m_aug_particle_size_state_new(
        ...
        auto* h = new n4m_aug_particle_size_handle_t{s, rng, wl_copy, n_wavelengths};
        *out = h;
        return N4M_OK;
    } catch (const std::bad_alloc&) { return N4M_ERR_OUT_OF_MEMORY; }
      catch (...) { return N4M_ERR_INTERNAL; }
...
N4M_API n4m_status_t n4m_augmentation_particle_size_apply(
    ...
    if (st != N4M_OK) return st;
    if ((st = validate_shapes(X, out)) != N4M_OK) return st;
    if (cols != h->n_wavelengths) return N4M_ERR_SHAPE_MISMATCH;
    try {
        return n4m_aug_particle_size_apply_impl(
...
// ============================================================================
struct n4m_aug_emsc_distort_handle_t {
    n4m_aug_emsc_distort_state_t* state;
    n4m_rng_pcg64_state_t* rng;
    double* wavelengths;
    int64_t n_wavelengths;
};
...
N4M_API n4m_status_t n4m_augmentation_emsc_distort_create(
    ...
    *out = nullptr;
    ...
    if (n_wavelengths <= 0) return N4M_ERR_INVALID_ARGUMENT;
    try {
        auto* s = n4m_aug_emsc_distort_state_new(
        ...
        std::memcpy(wl_copy, wavelengths,
                    static_cast<size_t>(n_wavelengths) * sizeof(double));
        auto* h = new n4m_aug_emsc_distort_handle_t{s, rng, wl_copy, n_wavelengths};
        *out = h;
        return N4M_OK;
    } catch (const std::bad_alloc&) { return N4M_ERR_OUT_OF_MEMORY; }
      catch (...) { return N4M_ERR_INTERNAL; }
...
N4M_API n4m_status_t n4m_augmentation_emsc_distort_apply(
    ...
    if (cols != h->n_wavelengths) return N4M_ERR_SHAPE_MISMATCH;
    try {
        return n4m_aug_emsc_distort_apply_impl(
            h->state, &h->rng->engine, Xp, rows, cols, h->wavelengths, Yp);
    } catch (...) { return N4M_ERR_INTERNAL; }
}
...
// ============================================================================
struct n4m_aug_batch_effect_handle_t {
    n4m_aug_batch_effect_state_t* state;
    n4m_rng_pcg64_state_t* rng;
...
N4M_API n4m_status_t n4m_augmentation_batch_effect_create(
    ...
    *out = nullptr;
    if (rng == nullptr) return N4M_ERR_NULL_POINTER;
    try {
        auto* s = n4m_aug_batch_effect_state_new(
        ...
        auto* h = new n4m_aug_batch_effect_handle_t{s, rng, wl_copy, n_wavelengths};
        *out = h;
        return N4M_OK;
    } catch (const std::bad_alloc&) { return N4M_ERR_OUT_OF_MEMORY; }
      catch (...) { return N4M_ERR_INTERNAL; }
...
N4M_API n4m_status_t n4m_augmentation_batch_effect_apply(
    ...
    try {
        return n4m_aug_batch_effect_apply_impl(
            h->state, &h->rng->engine, Xp, rows, cols, h->wavelengths, Yp);
    } catch (...) { return N4M_ERR_INTERNAL; }
}
...
// ============================================================================
struct n4m_aug_instrument_broaden_handle_t {
...
N4M_API n4m_status_t n4m_augmentation_instrument_broaden_create(
    ...
    *out = nullptr;
    if (rng == nullptr) return N4M_ERR_NULL_POINTER;
    try {
        auto* s = n4m_aug_instrument_broaden_state_new(
        ...
        auto* h = new n4m_aug_instrument_broaden_handle_t{s, rng, wl_copy, n_wavelengths};
        *out = h;
        return N4M_OK;
    } catch (const std::bad_alloc&) { return N4M_ERR_OUT_OF_MEMORY; }
      catch (...) { return N4M_ERR_INTERNAL; }
...
N4M_API n4m_status_t n4m_augmentation_instrument_broaden_apply(
    ...
    try {
        return n4m_aug_instrument_broaden_apply_impl(
            h->state, &h->rng->engine, Xp, rows, cols, h->wavelengths, Yp);
    } catch (...) { return N4M_ERR_INTERNAL; }
}
...
N4M_API void n4m_augmentation_instrument_broaden_destroy(
    ...
    try {
        if (h != nullptr) {
            n4m_aug_instrument_broaden_state_free(h->state);
            delete[] h->wavelengths;
            delete h;
        }
    } catch (...) {}
...
// DeadBandAugmenter
// ============================================================================
struct n4m_aug_dead_band_handle_t {
    n4m_aug_dead_band_state_t* state;
    n4m_rng_pcg64_state_t* rng;
};
...
N4M_API n4m_status_t n4m_augmentation_dead_band_create(
    ...
    *out = nullptr;
    if (rng == nullptr) return N4M_ERR_NULL_POINTER;
    try {
        auto* s = n4m_aug_dead_band_state_new(
            n_bands, width_low, width_high, noise_std, probability,
            variation_scope);
        if (s == nullptr) return N4M_ERR_INVALID_ARGUMENT;
        auto* h = new n4m_aug_dead_band_handle_t{s, rng};
        *out = h;
        return N4M_OK;
    } catch (const std::bad_alloc&) { return N4M_ERR_OUT_OF_MEMORY; }
      catch (...) { return N4M_ERR_INTERNAL; }
...
N4M_API n4m_status_t n4m_augmentation_dead_band_apply(
    ...
    if ((st = validate_shapes(X, out)) != N4M_OK) return st;
    try {
        return n4m_aug_dead_band_apply_impl(h->state, &h->rng->engine,
                                             Xp, rows, cols, Yp);
    } catch (...) { return N4M_ERR_INTERNAL; }
}
...
// ============================================================================
struct n4m_aug_temperature_handle_t {
    n4m_aug_temperature_state_t* state;
    n4m_rng_pcg64_state_t* rng;
    double* wavelengths;
    int64_t n_wavelengths;
};
...
N4M_API n4m_status_t n4m_augmentation_temperature_create(
    ...
    *out = nullptr;
    ...
    if (n_wavelengths <= 0) return N4M_ERR_INVALID_ARGUMENT;
    try {
        auto* s = n4m_aug_temperature_state_new(
        ...
        std::memcpy(wl_copy, wavelengths,
                    static_cast<size_t>(n_wavelengths) * sizeof(double));
        auto* h = new n4m_aug_temperature_handle_t{s, rng, wl_copy, n_wavelengths};
        *out = h;
        return N4M_OK;
    } catch (const std::bad_alloc&) { return N4M_ERR_OUT_OF_MEMORY; }
      catch (...) { return N4M_ERR_INTERNAL; }
...
N4M_API n4m_status_t n4m_augmentation_temperature_apply(
    ...
    if (cols != h->n_wavelengths) return N4M_ERR_SHAPE_MISMATCH;
    try {
        return n4m_aug_temperature_apply_impl(
            h->state, &h->rng->engine, Xp, rows, cols, h->wavelengths, Yp);
    } catch (...) { return N4M_ERR_INTERNAL; }
}
...
// MoistureAugmenter
// ============================================================================
struct n4m_aug_moisture_handle_t {
    n4m_aug_moisture_state_t* state;
    n4m_rng_pcg64_state_t* rng;
    double* wavelengths;
    int64_t n_wavelengths;
};
...
N4M_API n4m_status_t n4m_augmentation_moisture_create(
    ...
    *out = nullptr;
    ...
    if (n_wavelengths <= 0) return N4M_ERR_INVALID_ARGUMENT;
    try {
        auto* s = n4m_aug_moisture_state_new(
        ...
        std::memcpy(wl_copy, wavelengths,
                    static_cast<size_t>(n_wavelengths) * sizeof(double));
        auto* h = new n4m_aug_moisture_handle_t{s, rng, wl_copy, n_wavelengths};
        *out = h;
        return N4M_OK;
    } catch (const std::bad_alloc&) { return N4M_ERR_OUT_OF_MEMORY; }
      catch (...) { return N4M_ERR_INTERNAL; }
...
N4M_API n4m_status_t n4m_augmentation_moisture_apply(
    ...
    if (cols != h->n_wavelengths) return N4M_ERR_SHAPE_MISMATCH;
    try {
        return n4m_aug_moisture_apply_impl(
            h->state, &h->rng->engine, Xp, rows, cols, h->wavelengths, Yp);
    } catch (...) { return N4M_ERR_INTERNAL; }
}
